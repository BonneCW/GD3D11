;===============================================================================
;
;                         G2MDK - Xeres Rückkehr Setup-Script
;
...
!define MOD_NAME "D3D11 Renderer Clockwork Edition Gothic"                  ; Mod-Titel
...
InstallDir "$PROGRAMFILES\JoWooD\Gothic\"
...
!define MOD_REPORTVERSION "SOFTWARE\Microsoft\Windows\CurrentVersion\Gothic"
...
Section !$(NameSecModFiles) SecModFiles
  ...
  File /r  ".\Gothic1-GD3D11\*"
SectionEnd

!macro gmod_DeleteFile FILENAME
...
Section !un.$(NameSecModFiles) unSecModFiles
  ...
  !insertmacro gmod_DeleteFile "$INSTDIR\AntTweakBar.dll"
  !insertmacro gmod_DeleteFile "$INSTDIR\assimp-vc142-mt.dll"
  !insertmacro gmod_DeleteFile "$INSTDIR\COPYING"
  !insertmacro gmod_DeleteFile "$INSTDIR\d3dcompiler_47.dll"
  !insertmacro gmod_DeleteFile "$INSTDIR\ddraw.dll"
  !insertmacro gmod_DeleteFile "$INSTDIR\GFSDK_SSAO_D3D11.license.txt"
  !insertmacro gmod_DeleteFile "$INSTDIR\GFSDK_SSAO_D3D11.win32.dll"
